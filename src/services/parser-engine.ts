...
//  * Logic is delegated to focused subservices under `services/parser-engine/`:
...
// import { ParserBlockDispatchService } from './parser-engine/blockDispatchService';
// import { ParserEventRouteService } from './parser-engine/eventRouteService';
// import { ParserSessionStateService } from './parser-engine/sessionStateService';
// import type { DispatchBlockInput, EmitSessionResultInput, ParserTokenTraceRecord } from './parser-engine/types';
...
// export type { DispatchBlockInput, ParserTokenTraceRecord } from './parser-engine/types';
