...
export const registry: AceRegistryType.Parser = {
    name: 'context',
    slug: 'context',
    description: 'Session context management block for storing durable reasoning state or adjusting the active visible context window.',
    block_schema: {
        is_default_detail: true,
        purpose: 'Manage chaining-thought context memory. Use it to store concise reasoning state that must survive into the next loop, such as inferred user intent, plan, observed results, constraints, or important decisions. You may also use it to list a specific visible context window by index range.',
