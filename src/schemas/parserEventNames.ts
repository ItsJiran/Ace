export const PARSER_RUNTIME_EVENT = {
    ...
    // Legacy compatibility events still seen in older runtime paths.
    TOOL_ACTION_DISPATCH: 'tool_action_dispatch',
...
export const PARSER_RUNNING_EVENT_NAMES: readonly ParserRuntimeEventName[] = [
    ...
    PARSER_RUNTIME_EVENT.TOOL_ACTION_DISPATCH,
    PARSER_RUNTIME_EVENT.TOOL_ACTION_STARTED,
] as const;
...
export const PARSER_COMPLETED_EVENT_NAMES: readonly ParserRuntimeEventName[] = [
    ...
    PARSER_RUNTIME_EVENT.TOOL_ACTION_RESULT,
] as const;
...
export const PARSER_FAILED_EVENT_NAMES: readonly ParserRuntimeEventName[] = [
    ...
    PARSER_RUNTIME_EVENT.TOOL_ACTION_ERROR,
] as const;
