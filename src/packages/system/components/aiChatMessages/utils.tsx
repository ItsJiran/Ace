...
// import type { AIRendererType } from '#/shared/schemas/ai';
// import type { ToolChatPreview } from '#/shared/schemas/tooling';
// import { RegistryEngine } from '#/engines/registry-engine';

// export type AssistantSegment =
//     | { kind: 'paragraph'; renderer: AIRendererType }
//     | { kind: 'activity'; renderers: AIRendererType[] };

// export function resolveLatestTurnSpacing(turn: { assistant_renderers?: AIRendererType[] }): string {
...
// export function buildAssistantSegments(renderers: AIRendererType[]): AssistantSegment[] {
//     const segments: AssistantSegment[] = [];
//     let pendingActivity: AIRendererType[] = [];
