...
export function ToolWindowRenderer(props: ToolRendererProps) {
    const toolAction = typeof props.record.tool_name === 'string' ? props.record.tool_name : null;
    const windowItems = resolveWindowItems(props.content);
    ...
    return (
        <div className="flex flex-col gap-3">
            ...
            <ToolSection title="Window Artifact" icon={Braces} value={props.content} />
        </div>
    );
}