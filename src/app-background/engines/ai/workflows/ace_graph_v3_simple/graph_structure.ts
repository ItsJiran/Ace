...
const aceV3Graph = {
    ...
    edges: [
        ...
        { source: 'thought', target: 'action_speak', graph: 'ace-v3', type: 'route' },
        { source: 'thought', target: 'action_tool', graph: 'ace-v3', type: 'route' },
        { source: 'thought', target: 'action_context', graph: 'ace-v3', type: 'route' },
        { source: 'thought', target: 'action_mcp', graph: 'ace-v3', type: 'route' },
        { source: 'action_speak', target: 'thought', graph: 'ace-v3', type: 'route' },
        { source: 'action_tool', target: 'thought', graph: 'ace-v3', type: 'route' },
        { source: 'action_context', target: 'thought', graph: 'ace-v3', type: 'route' },
        { source: 'action_mcp', target: 'thought', graph: 'ace-v3', type: 'route' },
    ],
};
