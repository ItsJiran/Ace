...
const aceV3Graph = {
    ...
    nodes: [
        ...
        { id: 'action_memory', label: 'action_memory', graph: 'ace-v3', type: 'tool' },
        { id: 'action_mcp', label: 'action_mcp', graph: 'ace-v3', type: 'tool' },
        { id: 'action_write_file', label: 'action_write_file', graph: 'ace-v3', type: 'tool' },
        { id: 'action_shell', label: 'action_shell', graph: 'ace-v3', type: 'tool' },
        { id: 'action_read_file', label: 'action_read_file', graph: 'ace-v3', type: 'tool' },
    ...
    edges: [
        ...
        { source: 'action_dispatcher', target: 'action_memory', graph: 'ace-v3', type: 'route' },
        { source: 'action_dispatcher', target: 'action_mcp', graph: 'ace-v3', type: 'route' },
        { source: 'action_dispatcher', target: 'action_write_file', graph: 'ace-v3', type: 'route' },
        { source: 'action_dispatcher', target: 'action_shell', graph: 'ace-v3', type: 'route' },
        { source: 'action_dispatcher', target: 'action_read_file', graph: 'ace-v3', type: 'route' },
        ...
        { source: 'action_memory', target: 'action_dispatcher', graph: 'ace-v3', type: 'route' },
        { source: 'action_mcp', target: 'action_dispatcher', graph: 'ace-v3', type: 'route' },
        { source: 'action_write_file', target: 'action_dispatcher', graph: 'ace-v3', type: 'route' },
        { source: 'action_shell', target: 'action_dispatcher', graph: 'ace-v3', type: 'route' },
        { source: 'action_read_file', target: 'action_dispatcher', graph: 'ace-v3', type: 'route' },
