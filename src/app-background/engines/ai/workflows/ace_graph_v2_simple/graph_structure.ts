...
const aceV2Graph = {
    ...
    nodes: [
        ...
        { id: 'orchestrator_goal', label: 'orchestrator_goal', graph: 'ace-v2', type: 'llm' },
        ...
        { id: 'review_goal', label: 'review_goal', graph: 'ace-v2', type: 'llm' },
        { id: '__end__', label: 'END', graph: 'ace-v2', type: 'end' },
    ],
    edges: [
        { source: '__start__', target: 'thought', graph: 'ace-v2', type: 'route' },
        { source: 'thought', target: 'orchestrator_goal', graph: 'ace-v2', type: 'route' },
        { source: 'orchestrator_goal', target: 'orchestrator_step', graph: 'ace-v2', type: 'route' },
